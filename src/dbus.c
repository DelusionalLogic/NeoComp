...
static short cdbus_get_watch_cond(DBusWatch *watch) {
...
static bool cdbus_callback_handle_timeout(session_t *ps, timeout_t *ptmout);
...
static void cdbus_process(session_t *ps, DBusMessage *msg);
