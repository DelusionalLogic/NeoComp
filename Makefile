...
SOURCES += systems/blur.c systems/shadow.c texture.c renderutil.c textureeffects.c buffer.c systems/shape.c systems/fullscreen.c systems/texture.c systems/xorg.c
